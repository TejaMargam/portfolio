...
export default function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div
        className="absolute top-40 right-20 w-16 h-16 bg-violet-500/20 rounded-full animate-float"
        style={{ animationDelay: "2s" }}
      ></div>
      <div
        className="absolute bottom-40 left-20 w-24 h-24 bg-cyan-500/20 rounded-full animate-float"
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto leading-relaxed">
            Building real-time web and desktop applications with expertise in
            React.js, Node.js, Electron, and hardware-software integration for
