  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050d1a] dot-grid">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        {/* Stats */}
        <div className={`perspective-container grid grid-cols-2 md:grid-cols-4 gap-6 max-w-2xl mx-auto reveal-item ${mounted ? "revealed" : ""}`} style={{ transitionDelay: "600ms" }}>
          {stats.map((s, i) => (
            <div
              key={i}
              className="tilt-card glass-panel text-center p-4 rounded-xl cursor-default"
              onMouseMove={(e) => {
